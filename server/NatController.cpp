...
int NatController::setupIptablesHooks() {
    ...
    struct CommandsAndArgs defaultCommands[] = {
        ...
        {{IPTABLES_PATH, "-w", "-F", LOCAL_HW_TETHER_COUNTERS_CHAIN,}, 0},
        {{IPTABLES_PATH, "-w", "-X", LOCAL_HW_TETHER_COUNTERS_CHAIN,}, 0},
        {{IPTABLES_PATH, "-w", "-N", LOCAL_HW_TETHER_COUNTERS_CHAIN,}, 1},
